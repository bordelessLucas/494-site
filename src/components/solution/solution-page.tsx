        ...
        <main id="main-content">
              ...
              <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
                <div>
                  ...
                  <div className="mt-8 flex flex-wrap gap-4">
                    <OpenDemoButton variant="gradient" className="gap-2 px-6">
                      Solicitar Demonstração
                      <ArrowRight className="h-4 w-4" strokeWidth={1.75} />
                    </OpenDemoButton>
                    <Link href="#funcionalidades">
                      <MacPillButton variant="outline" className="px-6">
                        Ver Funcionalidades
                      </MacPillButton>
                    </Link>
                  </div>
            ...
            <div className="mac-container">
              ...
              <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                {details.features.map((feature, index) => (
                  <article key={feature.title} className="mac-card p-6">
            ...
            <div className="mac-container">
              ...
              <div className="mt-10 space-y-4">
                {details.flowSteps.map((step, index) => (
                  <div
                    key={step.title}
                    className="mac-card flex gap-5 p-6"
                  >
          ...
          {"highlights" in details &&
            details.highlights?.map((highlight) => (
              ...
              >
                <div className="mac-container">
                  <div className="mac-card p-8 md:p-12">
              ...
              <div className="mac-container">
                ...
                <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-2">
                  {details.audience.map((item) => (
                    <article key={item.segment} className="mac-card p-6">
                      <h3 className="font-display text-lg font-bold text-white">
                        {item.segment}
                      </h3>
                      <p className="mt-2 text-sm leading-relaxed text-zinc-400">
          ...
          <section className="mac-section border-t border-white/[0.06]">
            <div className="mac-container text-center">
              ...
              <OpenDemoButton variant="gradient" className="mt-8 gap-2 px-8">
